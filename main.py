...
def run():
    ...
    with open("covid_19_data.csv", "r") as dtb:
        asd = csv.reader(dtb)
        for i in asd:
            covid_records.append(i)

    covid_records = covid_records[1:len(covid_records)]
    display_record(covid_records[0],[0,3,5])
    main_menu = 0
    sub_menu = 0
    while True:
       ...
       # print(sub_menu)
        if sub_menu == 1:
            ...
            if sub_submenu == 1:
                task_17(covid_records)

            elif sub_submenu == 2:
                task_18(covid_records)


            elif sub_submenu == 3 :
                countries = task_19a(covid_records)
                task_19b(covid_records,countries)

            elif sub_submenu == 4 :
                countries = task_19a(covid_records)
                task_20(covid_records,countries)




            progress(operation="+", value=100)
        ...
        # TODO: Your code here
            ...
            if sub_submenu == 1:
                ...
                pychart_22(covid_records,countries)
            elif sub_submenu == 2:

                observation_chart_23(covid_records,countries)
            elif sub_submenu == 3:
                animated_summary_24(covid_records,countries)
